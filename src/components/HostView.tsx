...
const HostView = ({ sessionId, token, UID, currentSession }: { sessionId: string, token: string, UID: string; currentSession: any }) => {
    ...
    return <div className="grid grid-rows-[60px_auto_60px] h-screen w-screen p-4 gap-y-2">
        <div className="text-lightBurgundy text-[28px] font-[500] flex items-center">{currentSession?.title}</div>
        <div className={cn("grid grid-cols-1 grid-rows-1", {
            ...
            >
                ...
                <span className="absolute text-[12px] font-medium text-lightBurgundy bottom-[12px] left-[12px]">{UID}</span>
            </LocalUser>
